...
namespace Axiom {
	namespace Render{
		...
		#pragma endregion Debug stuff
				...
				VkImageView createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mip_levels = 1) {
				...
				void transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mip_levels = 1) {
					VkCommandBuffer commandBuffer = beginSingleTimeCommands();
