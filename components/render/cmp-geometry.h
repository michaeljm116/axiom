	...
	namespace Render
	{
		namespace Geometry
		{
			struct Cmp_Model_PBR
			{
				...
				Cmp_Model_PBR() = default;
				Cmp_Model_PBR(std::string n, uint32_t i) : name(std::move(n)), index(i) {}
				Cmp_Model_PBR(const Cmp_Model_PBR& other) = default;
				Cmp_Model_PBR(Cmp_Model_PBR&& other) noexcept = default;
				Cmp_Model_PBR& operator=(const Cmp_Model_PBR& other) = default;
				Cmp_Model_PBR& operator=(Cmp_Model_PBR&& other) noexcept = default;
			};
			...
			struct Vertex48
			{
				...
				Vertex48(const Vertex48 &other) = default;
				Vertex48(Vertex48 &&other) noexcept = default;
				Vertex48 &operator=(const Vertex48 &other) = default;
				Vertex48 &operator=(Vertex48 &&other) noexcept = default;
